        ...
        function($http)
        {
            ...
            this.getList = function(filters, sortby)
            {
                ...
                for(i = 0; i < memberlist.length; i++)
                {
                    ...
                    if(filters.state == 'Geburtstagsliste'	&& (member.CURRENT_STATE != 'aktiv' && member.CURRENT_STATE != 'Ehrenmitglied' &&
                                                                member.CURRENT_STATE != 'Ausbildung' && member.CURRENT_STATE.indexOf('Vorstand') === -1)) 		continue;
